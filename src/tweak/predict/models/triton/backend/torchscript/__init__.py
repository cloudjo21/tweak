...
class TritonClientModel(PredictableModel):
    ...
    def _make_infer_input_array(self, encoded, input_schema_map: OrderedDict):
        infer_input_array = []
        for i, (key_name, value_type) in enumerate(input_schema_map):
    ...
    def _infer_result(self, encoded: BatchEncoding, input_schema_map: list) -> ModelOutput:
        ...
        return result.as_numpy('logits__0')
