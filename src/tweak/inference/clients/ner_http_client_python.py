...
input_ids_np = np.concatenate((np.array([2, 12, 13, 14, 3]), np.full_like(np.arange(32-5), 1))).astype('int32').reshape(1, 32)
attention_mask_np = np.concatenate((np.array([1, 1, 1, 1, 1]), np.full_like(np.arange(32-5), 0))).astype('int32').reshape(1, 32)
token_types_np = np.concatenate((np.array([0, 1, 1, 1, 0]), np.full_like(np.arange(32-5), 0))).astype('int32').reshape(1, 32)
