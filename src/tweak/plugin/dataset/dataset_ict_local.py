...
@dataclass
class DatasetIctLocalConfig(datasets.BuilderConfig):
    """BuilderConfig for Inverse Cloze Task"""

    dataset_file_suffix = TAGGED_JSONL_SUFFIX


class DatasetIctLocal(datasets.GeneratorBasedBuilder):
    """Inverse Cloze Task dataset."""

    BUILDER_CONFIG_CLASS = DatasetIctLocalConfig

    BUILDER_CONFIGS = [
        DatasetIctLocalConfig(
            name="DatasetIctLocal",
    ...
    def __init__(self, **kwargs):
        super(DatasetIctLocal, self).__init__(**kwargs)
        self.logger = LOGGER
