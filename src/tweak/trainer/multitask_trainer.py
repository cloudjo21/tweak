...
class MultitaskTrainer(Trainer):
    def __init__(self, task_name_list, mtl_data_collator, **kwargs):
    ...
    def _compute_single_metrics(
        self, task_name: str, metric_key_prefix: str, output: PredictionOutput
    ) -> PredictionOutput:
        ...
        if (
            ...
            metrics = self.compute_metrics[task_name](
                EvalPrediction(predictions=preds, label_ids=label_ids), task_name
            )
        else:
            metrics = {}
