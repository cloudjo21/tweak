...
from tweak.model.ner.bilstm.char_bilstm import CharBiLSTM
...
class WordEmbedder(nn.Module):
    def __init__(
        ...
        static_context_emb: ContextualEmbeddingType = ContextualEmbeddingType.none.value,
        dropout: float = 0.5,
    ):
        """
        ...
        if self.static_context_emb != ContextualEmbeddingType.none:
